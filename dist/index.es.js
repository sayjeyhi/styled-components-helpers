...
var renderStyle = function (styles, interpolations) { return css(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), css.apply(void 0, __spreadArrays([styles], interpolations))); };
var breakpoint = function (name, styles, condition) {
    ...
    return css(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n    @media ", " {\n      ", "\n    }\n  "], ["\n    @media ", " {\n      ", "\n    }\n  "])), mediaCondition, css.apply(void 0, __spreadArrays([styles], interpolations)));
};
